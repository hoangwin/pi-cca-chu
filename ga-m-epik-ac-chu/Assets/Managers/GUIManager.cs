...
public class GUIManager : MonoBehaviour {
	...
	void Start () {
        ...
        m_Camera2d.SetActive(false);
        m_Camera3d.SetActive(true);
    ...
    public void ButtonChangeDirection()
    {
        ...
        if(m_Camera3d.activeSelf)
        {
            m_Camera3d.SetActive(false);
            m_Camera2d.SetActive(true);
        }
        else
        {
            m_Camera2d.SetActive(false);
