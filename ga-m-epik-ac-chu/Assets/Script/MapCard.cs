...
public class MapCard : MonoBehaviour {
    ...
    public void InitReset()
    {
        ...
        {
            if (GamePlay.instance.tranformObjSelect.gameObject.activeInHierarchy)
            {
                GamePlay.instance.tranformObjSelect.Translate(0, -1, 0);
                GamePlay.instance.tranformObjSelect = null;
            }
        }
        for (int i = 0; i < ROW + 2; i++)
        {
            ...
            for (int j = 0; j < COL + 2; j++)
            {
                ...
                else
                {
                  ...
                  //  Debug.Log(value);
                    ...
                    objChar.Translate((-j + 1) * _CELL_HEIGHT, 0, (i - 1.4f) * _CELL_WIDTH);
        ...
        GamePlay.instance.effectBoxselect.localScale = CardMatrix[1][1].gameObject.transform.localScale;
        GamePlay.instance.effectBoxselect.gameObject.SetActive(false);
        if (GamePlay.instance.tranformObjSelect != null)
        {
           // if (GamePlay.instance.tranformObjSelect.gameObject.activeSelf)
           //     GamePlay.instance.tranformObjSelect.Translate(0, -1, 0);
        ...
        GamePlay.countHint = 0;// 3;
        GamePlay.countSort = 0;// 1;
